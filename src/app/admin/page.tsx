      ...
      <main className="mx-auto min-h-screen max-w-6xl px-6 py-12">
        <div className="mb-8 rounded-[2rem] border border-white/10 bg-[var(--panel)] p-8 shadow-glow">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link href="/admin/login" className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm">Đăng nhập admin</Link>
            <Link href="/admin/history" className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm">Lịch sử phòng</Link>
          </div>
        </div>
        <AdminQuizBuilder />
      </main>
